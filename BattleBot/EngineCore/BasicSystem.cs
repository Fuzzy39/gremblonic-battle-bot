...
namespace EngineCore
{
    ...
    /// <summary>
    /// <para>A BasicSystem provides convienence features to allow a system to automatically subscribe to certain entities based on their components.
    /// By default when making a system, extend from this class. If you need more control over what entities are updated by the system, implement System directly.
    /// </para>
